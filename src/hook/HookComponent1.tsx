...
// - react에서 컴포넌트의 상태와 생명주기에 따라 특정한 작업을 수행하도록 하는 특별 함수
// - use로 시작하는 함수
...
// - useReducer : 상태 로직을 관리하는 함수,상태 업데이트 로직을 컴포넌트 외부로 옮길 수 있게하여 코드관리를 수월하게 도와줌
// - useCallback : 메모리 내에서 함수를 재사용할 수 있도록 하는 함수, 렌더링없이 특정 함수를 실행할 수 있게 함
// - useMemo : 메모리 내에 계산된 값(함수 결과)을 지정하여 함수 재실행 없이 값을 사용할 수 있도록 하는 함수
