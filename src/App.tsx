...
// - 특정 URL 패턴에 대해서 컴포넌트를 각각 다르게 렌더링하고자 한다면 App.tsx에 <Routes> 컴포넌트와 <Route> 컴포넌트를 
// 사용하여 경로에 따라서 컴포넌트를 렌더링할 수 있음
...
function Layout() {
  ...
  return (
    <div>
      ...
      <Outlet/>
      <div style={{ height: '100px', backgroundColor: 'beige'}}></div>
    </div>
  )
}
    ...
    <Routes>
      <Route index element= {<h1>기본 페이지</h1>}/>
        <Route path='/component' element={<Layout/ >}>
          <Route index path='component' element={<Component />}/>
